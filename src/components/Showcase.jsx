  ...
  return (
    ...
    <div className="container">
        <div className="content">
            ...
            <a className="btn-yellow" title="Get Consulting" href="consulting.html">Get Consulting<i class="fa-solid fa-arrow-up-right"></i></a>
            <a className="btn-transparent" title="Learn More" href="services.html">Learn More<i class="fa-solid fa-arrow-up-right"></i></a>
        </div>
